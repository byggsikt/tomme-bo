...
def run(name, d, cats, nums=(), y="innstilt730", boot=True, B=300):
...
json.dump(out, open(os.path.join(DIR,"V-B3-05-modeller.json"),"w",encoding="utf-8"), indent=1, ensure_ascii=False, default=str)
for k,v in out.items():
